...
<head>
  ...
  <meta charset="UTF-8">
  <title><spring:message code="hunter.title" /></title>
    ...
    <div class="aui-header-inner">
      <div class="aui-header-before">
        ...
        <div class="aui-dropdown2 aui-style-default aui-dropdown2-in-header" id="app-switcher" style="left: 10px; top: 40px; display: none;" data-dropdown2-alignment="left" aria-hidden="true">
          <ul role="radiogroup">
            <li><a href="#" class="aui-dropdown2-radio interactive" role="radio" aria-checked="false"><spring:message code="hunter.code"/></a></li>
            <li><a class="aui-dropdown2-radio interactive checked" role="radio" aria-checked="true"><spring:message code="hunter.hunter"/></a></li>
            <li><a href="#" class="aui-dropdown2-radio interactive" role="radio" aria-checked="false"><spring:message code="hunter.download"/></a></li>
            <li><a href="#" class="aui-dropdown2-radio interactive" role="radio" aria-checked="false"><spring:message code="hunter.ask"/></a></li>
            <li><a href="#" class="aui-dropdown2-radio interactive" role="radio" aria-checked="false"><spring:message code="hunter.forum"/></a></li>
            <li><a href="#" class="aui-dropdown2-radio interactive" role="radio" aria-checked="false"><spring:message code="hunter.blog"/></a></li>
          </ul>
        </div>
      </div>
      <div class="aui-header-primary">
        <h1 id="logo" class="aui-header-logo aui-header-logo-confluence"><a href="#"><span class="aui-header-logo-device">Hunter</span></a></h1>
          <ul class="aui-nav" style="width: auto;">
            <li><a href="hunter.html">Rewards</a></li>
            <c:if test="${sessionScope.online}">
              <li><a href="#">My Rewards</a></li>
              <li><a href="#">Accepted Rewards</a></li>
              <li><a href="#">Messages</a></li>
              <li style="display: inline-block;"><a id="aui-responsive-header-dropdown-trigger-more-2" class="aui-dropdown2-trigger" aria-owns="aui-responsive-header-dropdown-content-more-2" aria-haspopup="true" href="#">More<span class="icon aui-icon-dropdown"></span></a><div id="aui-responsive-header-dropdown-content-more-2" class="aui-dropdown2 aui-style-default"><div class="aui-dropdown2-section"><ul id="aui-responsive-header-dropdown-list-more-2"><li><a href="#">Calendars</a></li></ul></div></div></li><li><a class="aui-button aui-style aui-button-primary" href="#"><spring:message code="entity.mission.create"/></a></li>
            </c:if>
          </ul>
      </div>
